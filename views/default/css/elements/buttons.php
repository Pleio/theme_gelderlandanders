...
.elgg-button-submit {
	...
	background: #<?php echo THEME_COLOR_2;?> url(<?php echo elgg_get_site_url(); ?>_graphics/button_graduation.png) repeat-x left 10px;
}
...
.elgg-button-delete {
	...
	background: #<?php echo THEME_COLOR_4;?> url(<?php echo elgg_get_site_url(); ?>_graphics/button_graduation.png) repeat-x left 10px;
	text-shadow: 1px 1px 0px black;
}
